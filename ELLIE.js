...
const kaidate = moment.tz('Asia/Dhaka').format('DD/MM/YYYY');
...
if( smallinput.includes('konichiwa') || smallinput.includes('konochiwa') || smallinput.includes('konichiba') || smallinput.includes('salute')){
  reply (`Konichiwa ${pushname}, I am ELLIE. How can i help you?`);
}
...
const responses = {
  ...
  slasher: `My Boss is lost in Anime World, and I lost connection with him...`,
...
//
    ...
    let { data } = await axios.get('https://api.github.com/repos/khadherinc/ELLIE');
    teks = `*ELLIE Script*\n\n*Total Stars*: ${data.stargazers_count}⭐\n*Total Forks*: ${data.forks_count} forks\n*GitHub*: https://github.com/khadherinc/ELLIE\n\nDont forget to follow me on *GitHub* and give a ⭐️ to my projects. `
  /*  let buttons = [
   ...
   /* footer: `${BotName}`,
    ...
    mediaUrl: 'github.com/khadherinc/ELLIE',
    sourceUrl: "github.com/khadherinc/ELLIE"
    }}
    ...
    case 'support': case 'supportgc': {
      ...
      A17.sendMessage(from, { react: { text: "💫" , key: m.key }})
    reply(`⚙ *My developer's group:* ⚙ https://chat.whatsapp.com/L4UmJhLe12C8fOUob2GsNH`)
    }
    break;
...
case 'repo': case 'botrepo': {
  ...
  A17.sendMessage(from, { react: { text: "💫" , key: m.key }})
    reply(`⚙ My Source Code is </> - https://github.com/khadherinc/ELLIE`)
    }
    break;
...
A17.sendMessage(from, { react: { text: '❤', key: m.key }});
 ...
 //-------------------------------------------------------------------------------------------------------------------------//
  ...
  Type *surrender* to surrender and admit defeat...`
      ...
      for (let mod of global.Owner.map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').filter(v => v != '7560920774@s.whatsapp.net'))
...
case 'getcase':
if (isBan) return reply(mess.banned);	
if (m.sender !='917560920774@s.whatsapp.net') {return;}
...
if (!isBaileys) return reply('How can i delete messages of other person? Bro!')
...
if (!m.quoted) return reply('Please mention a message Bro!')
...
let teks = ` 「  ELLIE pm user list  」\n\nTotal ${anu.length} users are using ELLIE in personal chat.`
for (let i of anu) {
...
let teks = ` 「  ELLIE group user list  」\n\nTotal ${anu.length} users are using ELLIE in Groups.`
for (let i of anu) {
...
sendOrder(m.chat, teks, "667140254502463", fs.readFileSync('./KHADHERINC-MEDIA/ELLIE.jpg'), `${global.packname}`, `${global.BotName}`, "7560920074@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
} else if (sizny > 20) {
await A17.groupAcceptInvite(vcc).then(async(res) => reply(jsonformat(res))).catch(_ => _)
reply("Joined !")
} else {
...

{
  ...
  if (!text) {
    return reply(`Where is the link?\n\nExample: ${prefix + command} https://www.instagram.com/`);
  }
...
case 'music': case 'p': case 'play': case 'song': case 'ytplay': {
 ...
 caption: `「  ᴇʟʟɪᴇ Yᴏᴜᴛᴜʙᴇ Pʟᴀʏᴇʀ 2.0  」
...
A17.sendMessage(from, {video:{url:ytmp4play.videoUrl}, mimetype:"video/mp4", caption:anu.title+' By *ᴇʟʟɪᴇ*',}, {quoted:m})
}
...
if (!args.join(" ")) return reply(`Like use -take ᴇʟʟɪᴇ `)
const swn = args.join(" ")
...
break;
    ...
    case 'coremenu': case 'core-menu': case 'core': case 'c':
        ...
        if (isBanChat) return reply(mess.bangc);
        A17.sendMessage(from, { react: { text: "📕" , key: m.key }})
let corel ='https://wallpapercave.com/wp/wp12002210.jpg'
  const coremenu = ` 
┌──❖
│Hi 👤
└┬❖   Uꜱᴇʀ :  ${pushname} 
...
└──────────────···▸▸▸`
  ...
  case 'ownermenu': case 'owner-menu': case 'ownermennu': case 'o':
        ...
        if (isBanChat) return reply(mess.bangc);
        A17.sendMessage(from, { react: { text: "📕" , key: m.key }})
let ownerl ='https://wallpapercave.com/wp/wp12002210.jpg'
  const ownermenu = ` 
┌──❖
│Hi 👤
└┬❖   Uꜱᴇʀ :  ${pushname} 
...
└──────────────···▸▸▸`
  ...
  case 'groupmenu': case 'group-menu': case 'groupmennu': case 'g':
        ...
        if (isBanChat) return reply(mess.bangc);
        A17.sendMessage(from, { react: { text: "📕" , key: m.key }})
let groupl ='https://wallpapercave.com/wp/wp12002210.jpg'
  const groupmenu = ` 
┌──❖
│Hi 👤
└┬❖   Uꜱᴇʀ :  ${pushname} 
...
└──────────────···▸▸▸`
  ...
  case 'aimenu': case 'ai-menu': case 'aimennu': case 'ai':
        ...
        if (isBanChat) return reply(mess.bangc);
        A17.sendMessage(from, { react: { text: "📕" , key: m.key }})
let aimel ='https://wallpapercave.com/wp/wp12002210.jpg'
  const aimenu = ` 
┌──❖
│Hi 👤
└┬❖   Uꜱᴇʀ :  ${pushname} 
...
└──────────────···▸▸▸`
  ...
  case 'antilinkmenu': case 'antilink-menu': case 'antilinkmennu': case 'alm':
        ...
        if (isBanChat) return reply(mess.bangc);
        A17.sendMessage(from, { react: { text: "📕" , key: m.key }})
let antil ='https://wallpapercave.com/wp/wp12002210.jpg'
  const antilinkmenu = ` 
┌──❖
│Hi 👤
└┬❖   Uꜱᴇʀ :  ${pushname} 
...
└───────────────···▸▸▸`
  ...
  case 'economymenu': case 'economy-menu': case 'economymennu': case 'elm':
        ...
        if (isBanChat) return reply(mess.bangc);
        A17.sendMessage(from, { react: { text: "📕" , key: m.key }})
let economyl ='https://wallpapercave.com/wp/wp12002210.jpg'
  const economymenu = ` 
┌──❖
│Hi 👤
└┬❖   Uꜱᴇʀ :  ${pushname} 
...
└───────────────···▸▸▸`
  ...
  case 'convertermenu': case 'converter-menu': case 'convertmennu': case 'clm':
        ...
        if (isBanChat) return reply(mess.bangc);
        A17.sendMessage(from, { react: { text: "📕" , key: m.key }})
let converterl ='https://wallpapercave.com/wp/wp12002210.jpg'
  const convertmenu = ` 
┌──❖
│Hi 👤
└┬❖   Uꜱᴇʀ :  ${pushname} 
...
│╰────────────···▸▸`
  ...
  case 'downloadermenu': case 'downloader-menu': case 'downloadermennu': case 'dlm':
        ...
        if (isBanChat) return reply(mess.bangc);
        A17.sendMessage(from, { react: { text: "📕" , key: m.key }})
let downloaderl ='https://wallpapercave.com/wp/wp12002210.jpg'
...
└──────────────···▸▸▸`
  ...
  case 'reactionmenu': case 'reaction-menu': case 'reactionmennu': case 'rlm':
        ...
        if (isBanChat) return reply(mess.bangc);
        A17.sendMessage(from, { react: { text: "📕" , key: m.key }})
let reactionl ='https://wallpapercave.com/wp/wp12002210.jpg'
  const reactionmenu = ` 
┌──❖
│Hi 👤
└┬❖   Uꜱᴇʀ :  ${pushname} 
...
└──────────────···▸▸▸`
  ...
  case 'miscmenu': case 'misc-menu': case 'miscmennu': case 'mlm':
        ...
        if (isBanChat) return reply(mess.bangc);
        A17.sendMessage(from, { react: { text: "📕" , key: m.key }})
let miscl ='https://wallpapercave.com/wp/wp12002210.jpg'
  const miscmenu = ` 
┌──❖
│Hi 👤
└┬❖   Uꜱᴇʀ :  ${pushname} 
...
└──────────────···▸▸`
  ...
  case 'gamesmenu': case 'games-menu': case 'gamesmennu': case 'glm':
        ...
        if (isBanChat) return reply(mess.bangc);
        A17.sendMessage(from, { react: { text: "📕" , key: m.key }})
let gamesl ='https://wallpapercave.com/wp/wp12002210.jpg'
  const gamesmenu = ` 
┌──❖
│Hi 👤
└┬❖   Uꜱᴇʀ :  ${pushname} 
...
│╰───────────···▸▸`
  ...
  case 'animemenu': case 'anime-menu': case 'weebsmennu': case 'wlm':
        ...
        if (isBanChat) return reply(mess.bangc);
        A17.sendMessage(from, { react: { text: "📕" , key: m.key }})
let animel ='https://wallpapercave.com/wp/wp12002210.jpg'
  const weebsmenu = ` 
┌──❖
│Hi 👤
└┬❖   Uꜱᴇʀ :  ${pushname} 
...
└──────────────···▸▸▸`
  ...
  case 'stalkermenu': case 'stalker-menu': case 'stalkermennu': case 'slm':
        ...
        if (isBanChat) return reply(mess.bangc);
        A17.sendMessage(from, { react: { text: "📕" , key: m.key }})
let stalkerl ='https://wallpapercave.com/wp/wp12002210.jpg'
  const stalkermenu = ` 
┌──❖
│Hi 👤
└┬❖   Uꜱᴇʀ :  ${pushname} 
...
└───────────────···▸▸▸`
  ...
  break;
    ...
    case 'help': case 'h': case 'menu': case 'allmenu': case 'listmenu':
        ...
        if (isBanChat) return reply(mess.bangc);
        A17.sendMessage(from, { react: { text: "📕" , key: m.key }})
  let helpmenu54 ='https://wallpapercave.com/wp/wp12002210.jpg'
  const helpmenu = ` 
❒│▸  *Uꜱᴇʀ :  ${pushname}* !!! ✅
❒│▸  *Nᴏᴡ-ᴛɪᴍᴇ : ${nowtime}*  
❒│▸  *Tɪᴍᴇ : ${kaitime}* ⌚
...
A17.sendMessage(from, { react: { text: "🍁" , key: m.key }})
  ...
  var replqr =  await getBuffer(`https://khadherinc.github.io/abd-khadher____/`)
                     /*        var qrbutton = [
...
// //  "parse-ms": "^1.1.0",
      ...
      if(isCmd){
          ...
          if (isBanChat) return reply(mess.bangc);
          A17.sendMessage(from, { react: { text: "❌", key: m.key }}) 
          reply (`Oiiiiii  *${pushname}* Bro! this command are not programmed! Type *${prefix}help* to get my full command list!`)
