  const fs = require('fs')
  let _inventoryOrang = JSON.parse(fs.readFileSync('./KHADHERINC-STORAGE/user/inventory.json'))
  ...
  const addInventori = (sender) => {
        ...
        fs.writeFileSync('./KHADHERINC-STORAGE/user/inventory.json', JSON.stringify(_inventoryOrang))
   }
